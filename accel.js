   ...
   // When you get an accelermeter change, print it out:
    function listenForAcc() {
        tag.on('accelerometerChange', function(x, y, z) {
          ...
          /*  var time = int(Date.now()) / 1000 - 1468472410; //seconds from midnight
    ...
    function sendData(buffer){  //post request
        request.post('http://node-red-input-tester.mybluemix.net/bike-data/').form(buffer)
    }*/
